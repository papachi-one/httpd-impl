...
public final class StandardHttpOptions {
    ...
    public static final HttpOption<Boolean> HTTP_2 = new StdHttpOption<>("HTTP_2", Boolean.class, false);// HTTP/2.0
    public static final HttpOption<HttpsTLSSupplier> TLS = new StdHttpOption<>("TLS", HttpsTLSSupplier.class, null);// HTTP/1.1, HTTP/2.0
    public static final HttpOption<Integer> CONNECTION_IDLE_TIMEOUT = new StdHttpOption<>("CONNECTION_IDLE_TIMEOUT", Integer.class, 60);// HTTP/1.1, HTTP/2.0
    public static final HttpOption<Integer> READ_BUFFER_SIZE = new StdHttpOption<>("READ_BUFFER_SIZE", Integer.class, 32 * 1024);// HTTP/1.1, HTTP/2.0
    public static final HttpOption<Integer> WRITE_BUFFER_SIZE = new StdHttpOption<>("WRITE_BUFFER_SIZE", Integer.class, 32 * 1024);// HTTP/1.1, HTTP/2.0
    ...
    public static final HttpOption<Integer> MAX_FRAME_SIZE = new StdHttpOption<>("MAX_FRAME_SIZE", Integer.class, 16384);//HTTP/2.0
    public static final HttpOption<Integer> MAX_CONCURRENT_STREAMS = new StdHttpOption<>("MAX_CONCURRENT_STREAMS", Integer.class, Integer.MAX_VALUE);// HTTP/2.0
    public static final HttpOption<Integer> HEADER_TABLE_SIZE = new StdHttpOption<>("HEADER_TABLE_SIZE", Integer.class, 4096);//HTTP/2.0
